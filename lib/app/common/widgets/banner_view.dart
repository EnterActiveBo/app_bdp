...
class BannerView extends StatefulWidget {
  ...
  /// The initial page to show when first creating the [T5CarouselSlider].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [T5CarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [T5CarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [T5CarouselSlider].
  ///
  ...
  /// Animates the controlled [T5CarouselSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
...
class _BannerSliderState extends State<BannerView>
